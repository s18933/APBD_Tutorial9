...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task3()
        {
            var res = Emps.OrderByDescending(x => x.Salary).Select(x => x.Salary).First().ToString();
        }
        ...
        public void Task4()
        {
            var res = Emps.Where(emp => emp.Salary == Emps.OrderByDescending(x => x.Salary).Select(x => x.Salary).First()).ToList();
        }
        ...
        public void Task10()
        {
            var o =  new[] { new { Name = "No Value", Job = "null"} }; //The properties of anonymous types are read-only and cannot be initialized with a null, so I excluded HireDate
        ...
        public void Task12()
        {
            //I haven't chosen all attributes for convenience
            //LINQ
            var res = from emp in Emps
                      from dept in Depts
                      select new
